              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-4 py-3 rounded-xl border border-black/10 focus:border-[#5B5CF0] focus:outline-none transition"
                  >
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 rounded-xl border border-black/10 focus:border-[#5B5CF0] focus:outline-none transition resize-none"
                  />
                </div>
                ...
                <button
                  type="submit"
                  className="w-full h-14 rounded-xl bg-[#5B5CF0] text-white font-semibold hover:scale-[1.02] transition-transform flex items-center justify-center gap-3"
                >
            ...
            <div className="mt-12 pt-8 border-t border-black/5">
              <div className="grid md:grid-cols-3 gap-6 text-center">
                <div>
                  ...
                  <p className="text-sm text-black/60">hello@fusivox.com</p>
                </div>
                <div>
